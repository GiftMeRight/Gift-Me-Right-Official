...
export default function SuccessFamilyBrainstorm() {
  return (
    <main className="px-6 py-16 max-w-4xl mx-auto">
      <SectionGlow>
        <h1 className="text-4xl font-bold text-center mb-4">
          Family Brainstorm Game 🎉
        </h1>
        <p className="text-center text-gray-700">
          Your game is ready! This pack is designed to spark laughter,
          storytelling, and meaningful family connection.
        </p>
      </SectionGlow>
    </main>
  );
