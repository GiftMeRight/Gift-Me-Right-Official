...
export default function SuccessLearningAboutLove() {
  return (
    <main className="px-6 py-16 max-w-4xl mx-auto">
      <SectionGlow>
        ...
        <p className="text-center text-gray-700">
          Your presentation is ready. This guide walks through the foundations of
          healthy connection, attachment, and emotional awareness.
        </p>
      </SectionGlow>
    </main>
  );
