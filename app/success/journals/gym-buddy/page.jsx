...
export default function GymBuddyJournalSuccess() {
  return (
    <main className="min-h-screen bg-black px-6 py-16 flex items-center justify-center">
      <section className="bg-white rounded-3xl p-10 max-w-xl w-full text-center shadow-lg">
        ...
        <p className="text-gray-700 mb-8">
          Your motivation and accountability journal is ready — designed
          to support consistency, growth, and shared goals.
        </p>

        <a
          href="/downloads/GYMBUDDYJOURNALINTERIOR.pdf"
          target="_blank"
