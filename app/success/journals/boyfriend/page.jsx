...
export default function BoyfriendJournalSuccess() {
  return (
    <main className="min-h-screen bg-black px-6 py-16 flex items-center justify-center">
      <section className="bg-white rounded-3xl p-10 max-w-xl w-full text-center shadow-lg">
        ...
        <p className="text-gray-700 mb-8">
          Your guided relationship journal is ready. Use it to reflect,
          appreciate, and deepen your emotional connection.
        </p>

        <a
          href="/downloads/FINALIZEDBOYFRIENDJOURNALINTERNAL1.pdf"
          target="_blank"
