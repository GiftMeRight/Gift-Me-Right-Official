...
export default function BestFriendJournalSuccess() {
  return (
    <main className="min-h-screen bg-black px-6 py-16 flex items-center justify-center">
      <section className="bg-white rounded-3xl p-10 max-w-xl w-full text-center shadow-lg">
        ...
        <p className="text-gray-700 mb-8">
          Your friendship reflection journal is ready — filled with prompts
          for gratitude, memories, and meaningful connection.
        </p>

        <a
          href="/downloads/FINALIZEDBFFJOURNAL.pdf"
          target="_blank"
