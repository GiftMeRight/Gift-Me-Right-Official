...
export default function GirlfriendJournalSuccess() {
  return (
    <main className="min-h-screen bg-black px-6 py-16 flex items-center justify-center">
      <section className="bg-white rounded-3xl p-10 max-w-xl w-full text-center shadow-lg">
        ...
        <p className="text-gray-700 mb-8">
          Your guided relationship journal is ready — filled with prompts
          for appreciation, reflection, and emotional closeness.
        </p>

        <a
          href="/downloads/GIRLFRIENDJOURNALINTERNAL.pdf"
          target="_blank"
