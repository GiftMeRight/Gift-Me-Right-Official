...
export default function SuccessScienceGiftGiving() {
  return (
    <main className="min-h-screen bg-black px-6 py-16 flex items-center justify-center">
      <section className="bg-white rounded-3xl p-10 max-w-xl w-full text-center shadow-lg">
        ...
        <p className="text-gray-700 mb-8">
          Learn the psychology behind meaningful gifts and how to make every
          gift actually land emotionally.
        </p>

        <a
          href="/downloads/science-of-gift-giving.pdf"
          target="_blank"
